...
actions!(
    ...
    [
        ...
        /// Toggles auto-approve mode. When enabled, pending tool authorization requests are automatically approved.
        ToggleAutoApprove,
        /// Sets the maximum number of auto-approvals allowed per session (0 = unlimited).
        SetAutoApproveLimit,
    ]
);
