...
pub struct EditorSettings {
    ...
    pub editor_background_image: Option<PathBuf>,
    pub editor_background_opacity: Option<f32>,
}
#[derive(Debug, Clone)]
pub struct Jupyter {
...
impl Settings for EditorSettings {
    fn from_settings(content: &settings::SettingsContent) -> Self {
        ...
        Self {
            ...
            editor_background_image: editor.editor_background_image.clone(),
            editor_background_opacity: editor.editor_background_opacity,
        }
    }
}
