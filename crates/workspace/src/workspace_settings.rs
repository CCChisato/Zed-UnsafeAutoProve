...
pub struct WorkspaceSettings {
    ...
    pub global_background_opacity: Option<f32>,
}
...
impl Settings for WorkspaceSettings {
    fn from_settings(content: &settings::SettingsContent) -> Self {
        ...
        Self {
            ...
            global_background_image: workspace.global_background_image.clone(),
            global_background_opacity: workspace.global_background_opacity,
        }
    }
}
