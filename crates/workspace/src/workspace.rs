...
use gpui::{
    ...
    WindowId, WindowOptions, actions, canvas, img, point, relative, size, transparent_black,
};
                            ...
                            .when_some(
                                {
                                    let (path, opacity) = {
                                        ...
                                        (
                                            settings
                                                ...
                                                .as_ref()
                                                .and_then(|path| {
                                                    path.as_path().is_file().then_some(path)
                                                })
                                                .cloned(),
                                            settings
                                    ...
                                    path.map(|path| (path, opacity))
                                },
                                |this, (path, bg_opacity)| {
                                    this.child(
                                        img(path)
                                            .absolute()
                                            .inset_0()
